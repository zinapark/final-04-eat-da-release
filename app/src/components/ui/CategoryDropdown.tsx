...
import { categoryOptions } from "@/lib/banchan";
  ...
  return (
    <div>
      <label className="text-display-2 font-semibold text-gray-800 mb-2">
        반찬 종류 <span className="text-eatda-orange">*</span>
      </label>
      <div ref={dropdownRef} className="relative">
        <button
          ...
          disabled={disabled}
          className={`w-full py-2 border-b-[0.5px] border-gray-400 text-display-2 bg-transparent focus:outline-none text-left cursor-pointer disabled:cursor-not-allowed ${value ? "text-gray-800" : "text-gray-500"}`}
        >
