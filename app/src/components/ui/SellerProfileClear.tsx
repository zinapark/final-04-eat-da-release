...
export default function SellerProfileClear() {
  return (
    <article className="flex items-start gap-2.5 self-stretch rounded-lg px-2.5">
      <div></div>
      <img
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-1">
        <header className="flex flex-col gap-0">
          ...
          <div className="flex items-center gap-0.5 text-paragraph font-regular text-gray-700">
            ...
            <span className="text-paragraph-sm text-eatda-orange">4.9</span>
        ...
        <p className="text-paragraph-sm font-regular text-gray-600">
          3년 주부 경력으로 정성스럽게 만든 집밥을 나눕니다. 아들 둘을 키우며
          매일 해온 손맛 그대로 담았어요.
        </p>
      </div>
    </article>
